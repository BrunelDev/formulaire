    ...
    <div className="w-full animate-fade-in opacity-0 [--animation-delay:0ms]">
      <div className="bg-[#f7f7f8]">
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-6">
          ...
          <ScrollArea
            className="w-full lg:w-[42%] h-[62vh] lg:h-[calc(100vh-172px)] px-2 sm:px-4 lg:px-5"
            scrollHideDelay={100}
          >
            <div className="w-full z-50 animate-fade-in opacity-0 [--animation-delay:800ms]">
              <InformationSummarySection />
            </div>
          </ScrollArea>
          <div className="w-full lg:w-[20%] animate-fade-in opacity-0 [--animation-delay:600ms]">
            <SummaryView />
          </div>
        </div>
      </div>

...
export const ClientReviewsSection = () => {
  ...
  return (
    <section className="relative w-full h-[400px] sm:h-[500px] lg:h-[calc(100vh-172px)] bg-[linear-gradient(180deg,rgba(2,19,39,0)_0%,rgba(2,19,39,1)_100%),url(/images/finalisation-hero.jpg)] bg-cover bg-center bg-no-repeat animate-fade-in opacity-0 [--animation-delay:200ms] rounded-lg lg:rounded-none">
